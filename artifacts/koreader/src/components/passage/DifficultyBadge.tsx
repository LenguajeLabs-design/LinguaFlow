...
const difficultyConfig: Record<string, { label: string; colors: string }> = {
  ...
  a2: { label: 'A2 · Elementary',         colors: 'bg-teal-100 text-teal-800 border-teal-200' },
  b1: { label: 'B1 · Intermediate',       colors: 'bg-blue-100 text-blue-800 border-blue-200' },
  b2: { label: 'B2 · Upper Int.',         colors: 'bg-violet-100 text-violet-800 border-violet-200' },
  c1: { label: 'C1 · Advanced',           colors: 'bg-orange-100 text-orange-800 border-orange-200' },
  c2: { label: 'C2 · Mastery',            colors: 'bg-rose-100 text-rose-800 border-rose-200' },
